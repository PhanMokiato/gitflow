...
girl(400, 200, 0.6, 0.6, 0, 0, RGB(130, 251, 255), RGB(227, 146, 89));

girl(700, 200, 1, 1, 1, 1, RGB(255, 105, 180), RGB(255, 218, 185));
...
txCircle (x * sizeX, y * sizeY, 100);

txCircle (x - 75 * sizeX, y + 550 * sizeY, 25);

txCircle (x + 75 * sizeX, y + 550 * sizeY, 25);

txLine(x * sizeX, y + 100 * sizeY, x - (200 - leftHand) * sizeX, y + 300 * sizeY);

txLine(x * sizeX, y + 100 * sizeY, x + (200 - rightHand) * sizeX, y + 300 * sizeY);

txLine(x * sizeX, y + 100 * sizeY, x - 100 * sizeX, y + 400 * sizeY);
...
txFloodFill(x * sizeX, y + 300 * sizeY);
